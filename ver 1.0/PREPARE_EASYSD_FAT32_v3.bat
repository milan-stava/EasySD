...
rem   - asks for user confirmation before preparation starts
...
rem   - it is safe to run this BAT more than once before MBD/MBH
rem     images are copied
rem ================================================================
...
echo - It is safe to run this preparation more than once before
echo   MBD/MBH images are copied.
echo.
...
echo.
echo The BAT will prepare the FAT32 root directory on:
echo   Drive : %TARGET%
